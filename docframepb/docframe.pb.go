...
type ProtoNewPage struct {
	...
	ComChannelUUIDs []string               `protobuf:"bytes,5,rep,name=comChannelUUIDs,proto3" json:"comChannelUUIDs,omitempty"`
	PaperTrayUUID   string                 `protobuf:"bytes,6,opt,name=paperTrayUUID,proto3" json:"paperTrayUUID,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
const file_build_docframe_proto_rawDesc = "" +
	...
	"\x0fcomChannelUUIDs\x18\x03 \x03(\tR\x0fcomChannelUUIDs\"\x89\x02\n" +
	...
	"\x0fcomChannelUUIDs\x18\x05 \x03(\tR\x0fcomChannelUUIDs\x12$\n" +
	"\rpaperTrayUUID\x18\x06 \x01(\tR\rpaperTrayUUID\"\x85\x02\n" +
