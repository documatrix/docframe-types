...
type ProtoStrikethroughSpec struct {
	...
	Style         ProtoRuleStyle     `protobuf:"varint,5,opt,name=style,proto3,enum=ProtoRuleStyle" json:"style,omitempty"` // extends UnderlineSpec
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ProtoLink struct {
	...
	XChildren                   []*ProtoDocumentElement `protobuf:"bytes,1,rep,name=_children,json=Children,proto3" json:"_children,omitempty"` // extends BranchDocumentElement
...
type ProtoImageListLevelSetting struct {
	...
	FixItalic       bool                      `protobuf:"varint,9,opt,name=fixItalic,proto3" json:"fixItalic,omitempty"`
	IndentionWidth  int32                     `protobuf:"varint,10,opt,name=indentionWidth,proto3" json:"indentionWidth,omitempty"`
	Color           *ProtoColor               `protobuf:"bytes,11,opt,name=color,proto3" json:"color,omitempty"` // extends ListLevelSetting
	ImageName       string                    `protobuf:"bytes,12,opt,name=imageName,proto3" json:"imageName,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type ProtoNumberListLevelSetting struct {
	...
	FontFamily       *ProtoFont                    `protobuf:"bytes,12,opt,name=fontFamily,proto3" json:"fontFamily,omitempty"`
	Bold             *ProtoBoxedBool               `protobuf:"bytes,13,opt,name=bold,proto3" json:"bold,omitempty"`
	Italic           *ProtoBoxedBool               `protobuf:"bytes,14,opt,name=italic,proto3" json:"italic,omitempty"` // extends TextListLevelSetting
...
type ProtoListSetting struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// extends DocumentElement
	Parent                  *ProtoDocumentElement    `protobuf:"bytes,1,opt,name=parent,proto3" json:"parent,omitempty"` // extends DocumentElement
	Name                    string                   `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
...
type ProtoNamedString struct {
	...
	// extends BranchDocumentElement
	XChildren       []*ProtoDocumentElement `protobuf:"bytes,1,rep,name=_children,json=Children,proto3" json:"_children,omitempty"`
	Parent          *ProtoDocumentElement   `protobuf:"bytes,2,opt,name=parent,proto3" json:"parent,omitempty"` // extends BranchDocumentElement
...
var file_build_docframe_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
		ExtensionType: (*bool)(nil),
		Field:         50100,
		Name:          "searchable",
		Tag:           "varint,50100,opt,name=searchable",
		Filename:      "build/docframe.proto",
	},
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
		...
		Field:         50101,
		Name:          "weight",
		Tag:           "fixed32,50101,opt,name=weight",
		Filename:      "build/docframe.proto",
	},
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
		...
		Field:         50102,
		Name:          "field_group",
		Tag:           "bytes,50102,opt,name=field_group",
		Filename:      "build/docframe.proto",
	},
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
		...
		Field:         50103,
		Name:          "identity",
		Tag:           "varint,50103,opt,name=identity",
		Filename:      "build/docframe.proto",
	},
}
...
var (
	// Marks a field's text content as searchable. Only string and
	// repeated string fields should carry this; other kinds are rejected by
	// consumers at schema-compile time.
	//
	// optional bool searchable = 50100;
	E_Searchable = &file_build_docframe_proto_extTypes[0]
	// Relevance multiplier applied to term frequencies from this field.
	// Defaults to 1.0 when searchable is set and weight is unset/zero.
	//
	// optional float weight = 50101;
	E_Weight = &file_build_docframe_proto_extTypes[1]
	// Logical group shown alongside a search result, e.g. "content", "name",
	// "alt", "other". Defaults to "other".
	//
	// optional string field_group = 50102;
	E_FieldGroup = &file_build_docframe_proto_extTypes[2]
	// Marks the field that carries an element's identity. Text found in the
	// subtree of the innermost element with an identity becomes searchable
	// under that element's uuid; text outside any identified element is not
	// indexed. Must sit on a singular string field.
	//
	// optional bool identity = 50103;
	E_Identity = &file_build_docframe_proto_extTypes[3]
)
...
const file_build_docframe_proto_rawDesc = "" +
	"\n" +
	"\x14build/docframe.proto\x1a google/protobuf/descriptor.proto\">\n" +
	...
	"\adebitor\x18\x02 \x01(\v2\x14.ProtoSwissQRDebitorR\adebitor\"\xac\x01\n" +
	"\x0eProtoLinebreak\x12-\n" +
	"\x06parent\x18\x01 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x02 \x03(\tR\x0fcomChannelUUIDs\x12\x18\n" +
	"\x04uuid\x18\x03 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\x12'\n" +
	...
	"\x01y\x18\x02 \x01(\bR\x01y\"M\n" +
	"\vProtoOption\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12,\n" +
	"\x05value\x18\x02 \x01(\tB\x16\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\xc0?\xb2\xbb\x18\acontentR\x05value\"\xef\x04\n" +
	"\x13ProtoBaseInputField\x12'\n" +
	"\x04name\x18\x01 \x01(\tB\x13\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\x00@\xb2\xbb\x18\x04nameR\x04name\x12\x12\n" +
	...
	"\fonChangeCode\x18\x06 \x01(\tR\fonChangeCode\x124\n" +
	"\vplaceholder\x18\a \x01(\tB\x12\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\xc0?\xb2\xbb\x18\x03altR\vplaceholder\x12*\n" +
	...
	"\vpdfFormName\x18\f \x01(\tR\vpdfFormName\x122\n" +
	"\n" +
	"pdfAltText\x18\r \x01(\tB\x12\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\xc0?\xb2\xbb\x18\x03altR\n" +
	"pdfAltText\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x0e \x03(\tR\x0fcomChannelUUIDs\x12\x18\n" +
	"\x04uuid\x18\x0f \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\"o\n" +
	...
	"\x0fcomChannelUUIDs\x18\x03 \x03(\tR\x0fcomChannelUUIDs\"\xdb\x02\n" +
	"\tProtoLink\x122\n" +
	"\t_children\x18\x01 \x03(\v2\x15.ProtoDocumentElementR\bChildren\x12&\n" +
	"\x03url\x18\x02 \x01(\tB\x14\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\x80?\xb2\xbb\x18\x05otherR\x03url\x12(\n" +
	...
	"\vbindUrlCode\x18\a \x01(\bR\vbindUrlCode\x12\x18\n" +
	"\x04uuid\x18\b \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\"\xf1\x05\n" +
	...
	"\vdoctypeCode\x18\x04 \x01(\tR\vdoctypeCode\"\xc6\x02\n" +
	"\x10ProtoListSetting\x12-\n" +
	"\x06parent\x18\x01 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x12'\n" +
	"\x04name\x18\x02 \x01(\tB\x13\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\x00@\xb2\xbb\x18\x04nameR\x04name\x12D\n" +
	...
	"\x0fcomChannelUUIDs\x18\x05 \x03(\tR\x0fcomChannelUUIDs\x12\x18\n" +
	"\x04uuid\x18\x06 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\"X\n" +
	"\x15ProtoBoxedListSetting\x12'\n" +
	"\x05value\x18\x01 \x01(\v2\x11.ProtoListSettingR\x05value\x12\x16\n" +
	"\x06isNull\x18\x02 \x01(\bR\x06isNull\"\xd4\x02\n" +
	"\x10ProtoNamedString\x122\n" +
	"\t_children\x18\x01 \x03(\v2\x15.ProtoDocumentElementR\bChildren\x12-\n" +
	"\x06parent\x18\x02 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x12'\n" +
	"\x04name\x18\x03 \x01(\tB\x13\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\x00@\xb2\xbb\x18\x04nameR\x04name\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x04 \x03(\tR\x0fcomChannelUUIDs\x12\x18\n" +
	"\x04uuid\x18\x05 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\x128\n" +
	"\vdescription\x18\x06 \x01(\tB\x16\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\xc0?\xb2\xbb\x18\acontentR\vdescription\x12\x1a\n" +
	"\bnameCode\x18\a \x01(\tR\bnameCode\x12\x1a\n" +
	"\bcodeMode\x18\b \x01(\bR\bcodeMode\"\xcd\x02\n" +
	...
	"\x13paragraphFormatUUID\x18\x06 \x01(\tR\x13paragraphFormatUUID\x12\x18\n" +
	"\x04uuid\x18\a \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\"\xdb\r\n" +
	...
	"\x0fcomChannelUUIDs\x18\x1d \x03(\tR\x0fcomChannelUUIDs\x12\x18\n" +
	"\x04uuid\x18\x1e \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\x12K\n" +
	"\x18skipSpaceOnStartOfColumn\x18\x1f \x01(\v2\x0f.ProtoBoxedBoolR\x18skipSpaceOnStartOfColumn\x12L\n" +
	"\x18bookmarkIndentationLevel\x18  \x01(\v2\x10.ProtoBoxedInt32R\x18bookmarkIndentationLevel\"\xd1\x01\n" +
	"\fProtoSection\x122\n" +
	"\t_children\x18\x01 \x03(\v2\x15.ProtoDocumentElementR\bChildren\x12-\n" +
	"\x06parent\x18\x02 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x12\x18\n" +
	"\x04uuid\x18\x03 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\x12\x1a\n" +
	"\bcDefUuid\x18\x04 \x01(\tR\bcDefUuid\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x05 \x03(\tR\x0fcomChannelUUIDs\"\xae\x01\n" +
	"\x14ProtoSpaceVertically\x12-\n" +
	"\x06parent\x18\x01 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x12#\n" +
	"\x05space\x18\x02 \x01(\v2\r.ProtoMeasureR\x05space\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x03 \x03(\tR\x0fcomChannelUUIDs\x12\x18\n" +
	"\x04uuid\x18\x04 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\"\xd1\x03\n" +
	"\tProtoSpan\x122\n" +
	"\t_children\x18\x01 \x03(\v2\x15.ProtoDocumentElementR\bChildren\x12-\n" +
	"\x06parent\x18\x02 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x12#\n" +
	...
	" \x03(\tR\x0fcomChannelUUIDs\"\xad\x03\n" +
	"\n" +
	"ProtoTable\x122\n" +
	"\t_children\x18\x01 \x03(\v2\x15.ProtoDocumentElementR\bChildren\x12-\n" +
	"\x06parent\x18\x02 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x12/\n" +
	"\bsettings\x18\x03 \x01(\v2\x13.ProtoTableSettingsR\bsettings\x123\n" +
	"\n" +
	"configName\x18\x04 \x01(\tB\x13\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\xc0?\xb2\xbb\x18\x04nameR\n" +
	"configName\x12#\n" +
	...
	"\x11elementProperties\x18\b \x01(\v2\x1c.ProtoTableElementPropertiesR\x11elementProperties\x12\x18\n" +
	"\x04uuid\x18\t \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\"\xeb\x01\n" +
	"\x10ProtoTableConfig\x12-\n" +
	"\x06parent\x18\x01 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x12/\n" +
	"\bsettings\x18\x02 \x01(\v2\x13.ProtoTableSettingsR\bsettings\x123\n" +
	"\n" +
	"configName\x18\x03 \x01(\tB\x13\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\xc0?\xb2\xbb\x18\x04nameR\n" +
	"configName\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x04 \x03(\tR\x0fcomChannelUUIDs\x12\x18\n" +
	"\x04uuid\x18\x05 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\"\xeb\x02\n" +
	...
	"\x06isNull\x18\x02 \x01(\bR\x06isNull\"\xc8\x02\n" +
	...
	"\x11elementProperties\x18\x05 \x01(\v2\x1c.ProtoTableElementPropertiesR\x11elementProperties\x12\x18\n" +
	"\x04uuid\x18\x06 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\"\x83\x02\n" +
	"\x1cProtoTableContentGroupConfig\x12-\n" +
	"\x06parent\x18\x01 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x12;\n" +
	"\bsettings\x18\x02 \x01(\v2\x1f.ProtoTableContentGroupSettingsR\bsettings\x123\n" +
	"\n" +
	"configName\x18\x03 \x01(\tB\x13\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\xc0?\xb2\xbb\x18\x04nameR\n" +
	"configName\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x04 \x03(\tR\x0fcomChannelUUIDs\x12\x18\n" +
	"\x04uuid\x18\x05 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\"\xc6\x01\n" +
	...
	"\x02ws\x18\x03 \x01(\v2\r.ProtoTableWSR\x02ws\"\xf3\x02\n" +
	"\rProtoTableRow\x122\n" +
	"\t_children\x18\x01 \x03(\v2\x15.ProtoDocumentElementR\bChildren\x12-\n" +
	...
	"\x11elementProperties\x18\x06 \x01(\v2\x1c.ProtoTableElementPropertiesR\x11elementProperties\x12\x18\n" +
	"\x04uuid\x18\a \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\"\xdd\x02\n" +
	"\x13ProtoTableRowConfig\x12-\n" +
	"\x06parent\x18\x01 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x122\n" +
	"\bsettings\x18\x02 \x01(\v2\x16.ProtoTableRowSettingsR\bsettings\x123\n" +
	"\n" +
	"configName\x18\x03 \x01(\tB\x13\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\xc0?\xb2\xbb\x18\x04nameR\n" +
	"configName\x124\n" +
	"\trowHeader\x18\x04 \x01(\tB\x16\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\x80?\xb2\xbb\x18\acontentR\trowHeader\x124\n" +
	"\trowFooter\x18\x05 \x01(\tB\x16\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\x80?\xb2\xbb\x18\acontentR\trowFooter\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x06 \x03(\tR\x0fcomChannelUUIDs\x12\x18\n" +
	"\x04uuid\x18\a \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\"c\n" +
	...
	"\x06isNull\x18\x02 \x01(\bR\x06isNull\"\xb3\x03\n" +
	...
	"\x0fcomChannelUUIDs\x18\a \x03(\tR\x0fcomChannelUUIDs\x12J\n" +
	"\x11elementProperties\x18\b \x01(\v2\x1c.ProtoTableElementPropertiesR\x11elementProperties\x12\x18\n" +
	"\x04uuid\x18\t \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\"\xa9\x02\n" +
	"\x14ProtoTableCellConfig\x12-\n" +
	"\x06parent\x18\x01 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x123\n" +
	"\bsettings\x18\x02 \x01(\v2\x17.ProtoTableCellSettingsR\bsettings\x123\n" +
	"\n" +
	"configName\x18\x03 \x01(\tB\x13\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\xc0?\xb2\xbb\x18\x04nameR\n" +
	"configName\x124\n" +
	"\bcellType\x18\x04 \x01(\v2\x18.ProtoBoxedTableCellTypeR\bcellType\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x05 \x03(\tR\x0fcomChannelUUIDs\x12\x18\n" +
	"\x04uuid\x18\x06 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\"\xdf\x03\n" +
	...
	"\x13repeatSubHeaderCode\x18] \x01(\tR\x13repeatSubHeaderCode\"\x96\x01\n" +
	"\tProtoText\x12-\n" +
	"\x06parent\x18\x01 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x120\n" +
	"\acontent\x18\x02 \x01(\tB\x16\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00@@\xb2\xbb\x18\acontentR\acontent\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x03 \x03(\tR\x0fcomChannelUUIDs\"\xbd\x05\n" +
	"\fProtoBarcode\x12%\n" +
	...
	"\apadding\x18\b \x01(\v2\r.ProtoMeasureR\apadding\x12*\n" +
	"\x04data\x18\t \x01(\tB\x16\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\x80?\xb2\xbb\x18\acontentR\x04data\x12*\n" +
	"\x10positionAbsolute\x18\n" +
	" \x01(\bR\x10positionAbsolute\x12(\n" +
	"\x0fcomChannelUUIDs\x18\v \x03(\tR\x0fcomChannelUUIDs\x12\x18\n" +
	"\x04uuid\x18\f \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\x12\x12\n" +
	"\x04code\x18\r \x01(\tR\x04code\x123\n" +
	"\vswissQRData\x18\x0e \x01(\v2\x11.ProtoSwissQRDataR\vswissQRData\x12,\n" +
	"\aaltText\x18\x0f \x01(\tB\x12\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\xc0?\xb2\xbb\x18\x03altR\aaltText\x12+\n" +
	"\x06uaMode\x18\x10 \x01(\x0e2\x13.ProtoBarcodeUAModeR\x06uaMode\x128\n" +
	"\ruaDescription\x18\x11 \x01(\tB\x12\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\xc0?\xb2\xbb\x18\x03altR\ruaDescription\"\x8e\x01\n" +
	"\x13ProtoBrickReference\x123\n" +
	"\n" +
	"internName\x18\x01 \x01(\tB\x13\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\xc0?\xb2\xbb\x18\x04nameR\n" +
	"internName\x12\x18\n" +
	"\aversion\x18\x02 \x01(\rR\aversion\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x03 \x03(\tR\x0fcomChannelUUIDs\"\xbd\x02\n" +
	"\n" +
	"ProtoBrick\x122\n" +
	"\t_children\x18\x01 \x03(\v2\x15.ProtoDocumentElementR\bChildren\x12-\n" +
	"\x06parent\x18\x02 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x12\x0e\n" +
	"\x02id\x18\x03 \x01(\x04R\x02id\x123\n" +
	"\n" +
	"internName\x18\x04 \x01(\tB\x13\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\xc0?\xb2\xbb\x18\x04nameR\n" +
	"internName\x12\x18\n" +
	"\x04uuid\x18\x05 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\x12\x1a\n" +
	"\beditable\x18\x06 \x01(\bR\beditable\x12(\n" +
	"\x0fcomChannelUUIDs\x18\a \x03(\tR\x0fcomChannelUUIDs\x12'\n" +
	"\x04name\x18\b \x01(\tB\x13\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\x00@\xb2\xbb\x18\x04nameR\x04name\"\xce\x02\n" +
	"\rProtoTemplate\x122\n" +
	"\t_children\x18\x01 \x03(\v2\x15.ProtoDocumentElementR\bChildren\x12-\n" +
	"\x06parent\x18\x02 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x03 \x03(\tR\x0fcomChannelUUIDs\x12\x18\n" +
	"\x04uuid\x18\x04 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\x12:\n" +
	...
	"\ftemplateUuid\x18\a \x01(\tR\ftemplateUuid\"\xda\x01\n" +
	"\vProtoHeader\x122\n" +
	"\t_children\x18\x01 \x03(\v2\x15.ProtoDocumentElementR\bChildren\x12-\n" +
	"\x06parent\x18\x02 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x12\x18\n" +
	"\x04uuid\x18\x03 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x04 \x03(\tR\x0fcomChannelUUIDs\x12$\n" +
	"\x04mode\x18\x05 \x01(\x0e2\x10.ProtoHeaderModeR\x04mode\"\xda\x01\n" +
	"\vProtoFooter\x122\n" +
	"\t_children\x18\x01 \x03(\v2\x15.ProtoDocumentElementR\bChildren\x12-\n" +
	"\x06parent\x18\x02 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x12\x18\n" +
	"\x04uuid\x18\x03 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\x12(\n" +
	...
	"ProtoImage\x12-\n" +
	"\x06parent\x18\x01 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x12$\n" +
	"\x03alt\x18\x02 \x01(\tB\x12\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\xc0?\xb2\xbb\x18\x03altR\x03alt\x12'\n" +
	"\x04name\x18\x03 \x01(\tB\x13\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\x00@\xb2\xbb\x18\x04nameR\x04name\x12\x10\n" +
	"\x03src\x18\x04 \x01(\tR\x03src\x12/\n" +
	"\bfilename\x18\x05 \x01(\tB\x13\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\xc0?\xb2\xbb\x18\x04nameR\bfilename\x12'\n" +
	...
	"\x03aia\x18\x10 \x01(\v2+.ProtoAdvancedIllustrationAreaImageSettingsR\x03aia\x12\x18\n" +
	"\x04uuid\x18\x11 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\x12A\n" +
	...
	"\x06uaMode\x18\x18 \x01(\x0e2\x11.ProtoImageUAModeR\x06uaMode\x128\n" +
	"\ruaDescription\x18\x19 \x01(\tB\x12\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\xc0?\xb2\xbb\x18\x03altR\ruaDescription\x12I\n" +
	"\x17leftBorderIsLeftMeasure\x18\x1a \x01(\v2\x0f.ProtoBoxedBoolR\x17leftBorderIsLeftMeasure\"\xb4\x02\n" +
	...
	"\beditable\x18\x06 \x01(\bR\beditable\x12'\n" +
	"\x04name\x18\a \x01(\tB\x13\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\x00@\xb2\xbb\x18\x04nameR\x04name\"\x8c\x02\n" +
	"\x0eProtoTextBrick\x122\n" +
	"\t_children\x18\x01 \x03(\v2\x15.ProtoDocumentElementR\bChildren\x12-\n" +
	"\x06parent\x18\x02 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x12\x18\n" +
	"\x04uuid\x18\x03 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\x12\x0e\n" +
	"\x02id\x18\x04 \x01(\x04R\x02id\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x05 \x03(\tR\x0fcomChannelUUIDs\x12\x1a\n" +
	"\beditable\x18\x06 \x01(\bR\beditable\x12'\n" +
	"\x04name\x18\a \x01(\tB\x13\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\x00@\xb2\xbb\x18\x04nameR\x04name\"\xba\x02\n" +
	"\rProtoVariable\x12-\n" +
	"\x06parent\x18\x01 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x12'\n" +
	"\x04path\x18\x02 \x01(\tB\x13\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\x00@\xb2\xbb\x18\x04nameR\x04path\x120\n" +
	"\acontent\x18\x03 \x01(\tB\x16\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00 @\xb2\xbb\x18\acontentR\acontent\x12\x1e\n" +
	"\n" +
	"formatUuid\x18\x04 \x01(\tR\n" +
	"formatUuid\x12;\n" +
	"\vspecialType\x18\x05 \x01(\x0e2\x19.ProtoVariableSpecialTypeR\vspecialType\x12\x18\n" +
	"\x04uuid\x18\x06 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\x12(\n" +
	"\x0fcomChannelUUIDs\x18\a \x03(\tR\x0fcomChannelUUIDs\"\xa1\x03\n" +
	...
	"\vdoctypeCode\x18\x04 \x01(\tR\vdoctypeCode\x128\n" +
	"\vhtmlContent\x18\x05 \x01(\tB\x16\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\x80?\xb2\xbb\x18\acontentR\vhtmlContent\x12\x1a\n" +
	"\bhtmlCode\x18\x06 \x01(\tR\bhtmlCode\x128\n" +
	"\vtextContent\x18\a \x01(\tB\x16\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00 @\xb2\xbb\x18\acontentR\vtextContent\x12\x1a\n" +
	"\btextCode\x18\b \x01(\tR\btextCode\x12(\n" +
	"\x0fcomChannelUUIDs\x18\t \x03(\tR\x0fcomChannelUUIDs\x12\x18\n" +
	"\x04uuid\x18\n" +
	" \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\"u\n" +
	"\x13ProtoApplyProtoCDef\x12\x1a\n" +
	"\bcDefUuid\x18\x01 \x01(\tR\bcDefUuid\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x02 \x03(\tR\x0fcomChannelUUIDs\x12\x18\n" +
	"\x04uuid\x18\x03 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\"u\n" +
	"\x13ProtoApplyProtoPDef\x12\x1a\n" +
	"\bpDefUuid\x18\x01 \x01(\tR\bpDefUuid\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x02 \x03(\tR\x0fcomChannelUUIDs\x12\x18\n" +
	"\x04uuid\x18\x03 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\"|\n" +
	...
	"\x0fcomChannelUUIDs\x18\x02 \x03(\tR\x0fcomChannelUUIDs\x12\x18\n" +
	"\x04uuid\x18\x03 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\"\x87\x02\n" +
	"\tProtoCDef\x12:\n" +
	...
	"\x0eapplyImmediate\x18\x03 \x01(\v2\x0f.ProtoBoxedBoolR\x0eapplyImmediate\x12\x18\n" +
	"\x04Uuid\x18\x04 \x01(\tB\x04\xb8\xbb\x18\x01R\x04Uuid\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x05 \x03(\tR\x0fcomChannelUUIDs\"\xb3\x01\n" +
	"\tProtoPDef\x120\n" +
	"\tpageWidth\x18\x01 \x01(\v2\x12.ProtoBoxedMeasureR\tpageWidth\x120\n" +
	"\tpageDepth\x18\x02 \x01(\v2\x12.ProtoBoxedMeasureR\tpageDepth\x12\x18\n" +
	"\x04Uuid\x18\x03 \x01(\tB\x04\xb8\xbb\x18\x01R\x04Uuid\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x04 \x03(\tR\x0fcomChannelUUIDs\"\x9f\x02\n" +
	"\rProtoPtConfig\x12*\n" +
	...
	"spaceWidth\x12\x18\n" +
	"\x04Uuid\x18\x05 \x01(\tB\x04\xb8\xbb\x18\x01R\x04Uuid\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x06 \x03(\tR\x0fcomChannelUUIDs\"|\n" +
	"\rProtoUlConfig\x12'\n" +
	"\x04mode\x18\x01 \x01(\x0e2\x13.ProtoUnderlineModeR\x04mode\x12\x18\n" +
	"\x04Uuid\x18\x02 \x01(\tB\x04\xb8\xbb\x18\x01R\x04Uuid\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x03 \x03(\tR\x0fcomChannelUUIDs\"\xe7\x02\n" +
	"\fProtoNewPage\x12\x18\n" +
	"\x04uuid\x18\x01 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\x12$\n" +
	...
	"\x0fcomChannelUUIDs\x18\t \x03(\tR\x0fcomChannelUUIDs\"\x8b\x02\n" +
	"\x10ProtoIndentation\x122\n" +
	"\t_children\x18\x01 \x03(\v2\x15.ProtoDocumentElementR\bChildren\x12-\n" +
	"\x06parent\x18\x02 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x12&\n" +
	"\x04left\x18\x03 \x01(\v2\x12.ProtoBoxedMeasureR\x04left\x12(\n" +
	"\x05right\x18\x04 \x01(\v2\x12.ProtoBoxedMeasureR\x05right\x12\x18\n" +
	"\x04uuid\x18\x05 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x06 \x03(\tR\x0fcomChannelUUIDs\"\xb7\x01\n" +
	"\x0eProtoCarryOver\x122\n" +
	"\t_children\x18\x01 \x03(\v2\x15.ProtoDocumentElementR\bChildren\x12-\n" +
	"\x06parent\x18\x02 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x03 \x03(\tR\x0fcomChannelUUIDs\x12\x18\n" +
	"\x04uuid\x18\x04 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\"\xe1\x01\n" +
	...
	"\x04uuid\x18\x05 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x06 \x03(\tR\x0fcomChannelUUIDs\"\xc6\x01\n" +
	"\tProtoLoop\x122\n" +
	"\t_children\x18\x01 \x03(\v2\x15.ProtoDocumentElementR\bChildren\x12-\n" +
	"\x06parent\x18\x02 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x12\x12\n" +
	"\x04path\x18\x03 \x01(\tR\x04path\x12\x18\n" +
	"\x04uuid\x18\x04 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x05 \x03(\tR\x0fcomChannelUUIDs\"\xba\x02\n" +
	"\rProtoSubTotal\x122\n" +
	"\t_children\x18\x01 \x03(\v2\x15.ProtoDocumentElementR\bChildren\x12-\n" +
	"\x06parent\x18\x02 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x12'\n" +
	...
	"\x0fcomChannelUUIDs\x18\x06 \x03(\tR\x0fcomChannelUUIDs\x12\x18\n" +
	"\x04uuid\x18\a \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\"\xb4\x01\n" +
	"\vProtoWsArea\x122\n" +
	"\t_children\x18\x01 \x03(\v2\x15.ProtoDocumentElementR\bChildren\x12-\n" +
	"\x06parent\x18\x02 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x03 \x03(\tR\x0fcomChannelUUIDs\x12\x18\n" +
	"\x04uuid\x18\x04 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\"\xb3\x03\n" +
	"\tProtoRule\x12'\n" +
	...
	"boundaries\x12(\n" +
	"\x0fcomChannelUUIDs\x18\n" +
	" \x03(\tR\x0fcomChannelUUIDs\x12\x18\n" +
	"\x04uuid\x18\v \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\"[\n" +
	"\x13ProtoRuleBoundaries\x12#\n" +
	"\x05start\x18\x01 \x01(\v2\r.ProtoMeasureR\x05start\x12\x1f\n" +
	"\x03end\x18\x02 \x01(\v2\r.ProtoMeasureR\x03end\"v\n" +
	"\rProtoColorDef\x12!\n" +
	"\x05color\x18\x01 \x01(\v2\v.ProtoColorR\x05color\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x02 \x03(\tR\x0fcomChannelUUIDs\x12\x18\n" +
	"\x04uuid\x18\x03 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\"\xa9\x01\n" +
	"\vProtoLayout\x12-\n" +
	"\x06parent\x18\x01 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x12'\n" +
	"\x04name\x18\x02 \x01(\tB\x13\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\x00@\xb2\xbb\x18\x04nameR\x04name\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x03 \x03(\tR\x0fcomChannelUUIDs\x12\x18\n" +
	"\x04uuid\x18\x04 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\"\xec\x03\n" +
	...
	"\x0fcomChannelUUIDs\x18\x05 \x03(\tR\x0fcomChannelUUIDs\x12\x18\n" +
	"\x04uuid\x18\x06 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\"\xf2\x01\n" +
	"\x12ProtoDoctypeScript\x12-\n" +
	"\x06parent\x18\x01 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x120\n" +
	"\acontent\x18\x02 \x01(\tB\x16\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\xc0?\xb2\xbb\x18\acontentR\acontent\x127\n" +
	"\n" +
	"outputMode\x18\x03 \x01(\x0e2\x17.ProtoDoctypeOutputModeR\n" +
	"outputMode\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x04 \x03(\tR\x0fcomChannelUUIDs\x12\x18\n" +
	"\x04uuid\x18\x05 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\"\xb4\x01\n" +
	"\rProtoDmScript\x12-\n" +
	"\x06parent\x18\x01 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x120\n" +
	"\acontent\x18\x02 \x01(\tB\x16\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\xc0?\xb2\xbb\x18\acontentR\acontent\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x03 \x03(\tR\x0fcomChannelUUIDs\x12\x18\n" +
	"\x04uuid\x18\x04 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\"\xb9\x01\n" +
	"\x14ProtoDynamicTemplate\x12-\n" +
	"\x06parent\x18\x01 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x12\x18\n" +
	"\x04uuid\x18\x02 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\x12.\n" +
	"\x06script\x18\x03 \x01(\tB\x16\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\x80?\xb2\xbb\x18\acontentR\x06script\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x04 \x03(\tR\x0fcomChannelUUIDs\"\xd3\x02\n" +
	"\x0eProtoSelection\x122\n" +
	"\t_children\x18\x01 \x03(\v2\x15.ProtoDocumentElementR\bChildren\x12-\n" +
	"\x06parent\x18\x02 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x12\x18\n" +
	"\x04uuid\x18\x03 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x04 \x03(\tR\x0fcomChannelUUIDs\x127\n" +
	"\finternalName\x18\x05 \x01(\tB\x13\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\xc0?\xb2\xbb\x18\x04nameR\finternalName\x12'\n" +
	"\x04name\x18\x06 \x01(\tB\x13\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\x00@\xb2\xbb\x18\x04nameR\x04name\x12\x14\n" +
	"\x05multi\x18\a \x01(\bR\x05multi\x12\x10\n" +
	"\x03min\x18\b \x01(\x04R\x03min\x12\x10\n" +
	"\x03max\x18\t \x01(\x04R\x03max\"\xa5\x02\n" +
	"\x13ProtoSelectionEntry\x122\n" +
	"\t_children\x18\x01 \x03(\v2\x15.ProtoDocumentElementR\bChildren\x12-\n" +
	"\x06parent\x18\x02 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x12\x18\n" +
	"\x04uuid\x18\x03 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x04 \x03(\tR\x0fcomChannelUUIDs\x12\"\n" +
	"\finternalName\x18\x05 \x01(\tR\finternalName\x12'\n" +
	"\x04name\x18\x06 \x01(\tB\x13\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\x00@\xb2\xbb\x18\x04nameR\x04name\x12\x1a\n" +
	"\bselected\x18\a \x01(\bR\bselected\"\x9b\x02\n" +
	"\x0eProtoCondition\x122\n" +
	"\t_children\x18\x01 \x03(\v2\x15.ProtoDocumentElementR\bChildren\x12-\n" +
	"\x06parent\x18\x02 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x12\x18\n" +
	"\x04uuid\x18\x03 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x04 \x03(\tR\x0fcomChannelUUIDs\x12*\n" +
	"\x04code\x18\x05 \x01(\tB\x16\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\x80?\xb2\xbb\x18\acontentR\x04code\x12\x16\n" +
	...
	"\x04uuid\x18\x03 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x04 \x03(\tR\x0fcomChannelUUIDs\x12*\n" +
	"\x04code\x18\x05 \x01(\tB\x16\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\x80?\xb2\xbb\x18\acontentR\x04code\"\xfc\x01\n" +
	"\vProtoLocale\x122\n" +
	"\t_children\x18\x01 \x03(\v2\x15.ProtoDocumentElementR\bChildren\x12-\n" +
	"\x06parent\x18\x02 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x12\x18\n" +
	"\x04uuid\x18\x03 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\x12(\n" +
	...
	"\vregionUUIDs\x18\x06 \x03(\tR\vregionUUIDs\"\xf6\x01\n" +
	"\bProtoTag\x12-\n" +
	"\x06parent\x18\x01 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x12'\n" +
	"\x04name\x18\x02 \x01(\tB\x13\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\x00@\xb2\xbb\x18\x04nameR\x04name\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x03 \x03(\tR\x0fcomChannelUUIDs\x12\x18\n" +
	"\x04uuid\x18\x04 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\x12\x16\n" +
	"\x06params\x18\x05 \x03(\tR\x06params\x12\x1a\n" +
	"\bnameCode\x18\x06 \x01(\tR\bnameCode\x12\x1a\n" +
	"\bcodeMode\x18\a \x01(\bR\bcodeMode\"\xe8\x01\n" +
	"\x18ProtoParagraphSetDefault\x12-\n" +
	"\x06parent\x18\x01 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x12'\n" +
	"\x04name\x18\x02 \x01(\tB\x13\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\x00@\xb2\xbb\x18\x04nameR\x04name\x120\n" +
	"\x13paragraphFormatUUID\x18\x03 \x01(\tR\x13paragraphFormatUUID\x12\x18\n" +
	"\x04uuid\x18\x04 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\x12(\n" +
	...
	"\rProtoSetColor\x12-\n" +
	"\x06parent\x18\x01 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x12'\n" +
	"\x05color\x18\x02 \x01(\v2\x11.ProtoColorChoiceR\x05color\x12\x18\n" +
	"\x04uuid\x18\x03 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x04 \x03(\tR\x0fcomChannelUUIDs\"\xad\x01\n" +
	"\x0fProtoUnsetColor\x12-\n" +
	"\x06parent\x18\x01 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x12'\n" +
	"\x05color\x18\x02 \x01(\v2\x11.ProtoColorChoiceR\x05color\x12\x18\n" +
	"\x04uuid\x18\x03 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x04 \x03(\tR\x0fcomChannelUUIDs\"\xe2\x01\n" +
	"\x10ProtoColoredArea\x12-\n" +
	"\x06parent\x18\x01 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x122\n" +
	"\t_children\x18\x02 \x03(\v2\x15.ProtoDocumentElementR\bChildren\x12'\n" +
	"\x05color\x18\x03 \x01(\v2\x11.ProtoColorChoiceR\x05color\x12\x18\n" +
	"\x04uuid\x18\x04 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x05 \x03(\tR\x0fcomChannelUUIDs\"\xf4\x02\n" +
	"\fProtoChapter\x122\n" +
	"\t_children\x18\x01 \x03(\v2\x15.ProtoDocumentElementR\bChildren\x12-\n" +
	"\x06parent\x18\x02 \x01(\v2\x15.ProtoDocumentElementR\x06parent\x12\x18\n" +
	"\x04uuid\x18\x03 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x04 \x03(\tR\x0fcomChannelUUIDs\x12)\n" +
	"\x05title\x18\x05 \x01(\tB\x13\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\x00@\xb2\xbb\x18\x04nameR\x05title\x12\x10\n" +
	...
	"\x06format\x18\x05 \x01(\tR\x06format\x120\n" +
	"\acontent\x18\x06 \x01(\tB\x16\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\xc0?\xb2\xbb\x18\acontentR\acontent\x12\x10\n" +
	"\x03key\x18\a \x01(\tR\x03key\"\xb3\x01\n" +
	"\x10ProtoChapterLink\x122\n" +
	"\t_children\x18\x01 \x03(\v2\x15.ProtoDocumentElementR\bChildren\x12\x18\n" +
	"\x04uuid\x18\x02 \x01(\tB\x04\xb8\xbb\x18\x01R\x04uuid\x12'\n" +
	"\x04name\x18\x03 \x01(\tB\x13\xa0\xbb\x18\x01\xad\xbb\x18\x00\x00\x00@\xb2\xbb\x18\x04nameR\x04name\x12(\n" +
	...
	"\x04JSON\x10\x02:?\n" +
	"\n" +
	"searchable\x12\x1d.google.protobuf.FieldOptions\x18\xb4\x87\x03 \x01(\bR\n" +
	"searchable:7\n" +
	"\x06weight\x12\x1d.google.protobuf.FieldOptions\x18\xb5\x87\x03 \x01(\x02R\x06weight:@\n" +
	"\vfield_group\x12\x1d.google.protobuf.FieldOptions\x18\xb6\x87\x03 \x01(\tR\n" +
	"fieldGroup:;\n" +
	"\bidentity\x12\x1d.google.protobuf.FieldOptions\x18\xb7\x87\x03 \x01(\bR\bidentityB\v\xaa\x02\bDocframeb\x06proto3"
...
var file_build_docframe_proto_goTypes = []any{
	...
	(*descriptorpb.FieldOptions)(nil),                      // 161: google.protobuf.FieldOptions
}
var file_build_docframe_proto_depIdxs = []int32{
	...
	70,  // 377: ProtoDirectory._children:type_name -> ProtoDocumentElement
	70,  // 378: ProtoDirectory.parent:type_name -> ProtoDocumentElement
	12,  // 379: ProtoDirectory.semanticType:type_name -> ProtoSemanticType
	70,  // 380: ProtoTextBrick._children:type_name -> ProtoDocumentElement
	70,  // 381: ProtoTextBrick.parent:type_name -> ProtoDocumentElement
	70,  // 382: ProtoVariable.parent:type_name -> ProtoDocumentElement
	27,  // 383: ProtoVariable.specialType:type_name -> ProtoVariableSpecialType
	70,  // 384: ProtoFormatted.parent:type_name -> ProtoDocumentElement
	61,  // 385: ProtoCDef.columSettings:type_name -> ProtoColumnSettings
	33,  // 386: ProtoCDef.applyToHeaderFooter:type_name -> ProtoBoxedBool
	33,  // 387: ProtoCDef.applyImmediate:type_name -> ProtoBoxedBool
	42,  // 388: ProtoPDef.pageWidth:type_name -> ProtoBoxedMeasure
	42,  // 389: ProtoPDef.pageDepth:type_name -> ProtoBoxedMeasure
	42,  // 390: ProtoPtConfig.height:type_name -> ProtoBoxedMeasure
	42,  // 391: ProtoPtConfig.lineFeed:type_name -> ProtoBoxedMeasure
	42,  // 392: ProtoPtConfig.characterWidth:type_name -> ProtoBoxedMeasure
	42,  // 393: ProtoPtConfig.spaceWidth:type_name -> ProtoBoxedMeasure
	10,  // 394: ProtoUlConfig.mode:type_name -> ProtoUnderlineMode
	28,  // 395: ProtoNewPage.pageMode:type_name -> ProtoPageMode
	29,  // 396: ProtoNewPage.pageOrientation:type_name -> ProtoPageOrientation
	70,  // 397: ProtoIndentation._children:type_name -> ProtoDocumentElement
	70,  // 398: ProtoIndentation.parent:type_name -> ProtoDocumentElement
	42,  // 399: ProtoIndentation.left:type_name -> ProtoBoxedMeasure
	42,  // 400: ProtoIndentation.right:type_name -> ProtoBoxedMeasure
	70,  // 401: ProtoCarryOver._children:type_name -> ProtoDocumentElement
	70,  // 402: ProtoCarryOver.parent:type_name -> ProtoDocumentElement
	70,  // 403: ProtoLoopEntry._children:type_name -> ProtoDocumentElement
	70,  // 404: ProtoLoopEntry.parent:type_name -> ProtoDocumentElement
	70,  // 405: ProtoLoop._children:type_name -> ProtoDocumentElement
	70,  // 406: ProtoLoop.parent:type_name -> ProtoDocumentElement
	70,  // 407: ProtoSubTotal._children:type_name -> ProtoDocumentElement
	70,  // 408: ProtoSubTotal.parent:type_name -> ProtoDocumentElement
	30,  // 409: ProtoSubTotal.position:type_name -> ProtoSubTotalPosition
	41,  // 410: ProtoSubTotal.height:type_name -> ProtoMeasure
	70,  // 411: ProtoWsArea._children:type_name -> ProtoDocumentElement
	70,  // 412: ProtoWsArea.parent:type_name -> ProtoDocumentElement
	41,  // 413: ProtoRule.xOffset:type_name -> ProtoMeasure
	41,  // 414: ProtoRule.yOffset:type_name -> ProtoMeasure
	41,  // 415: ProtoRule.width:type_name -> ProtoMeasure
	41,  // 416: ProtoRule.thickness:type_name -> ProtoMeasure
	48,  // 417: ProtoRule.color:type_name -> ProtoColor
	1,   // 418: ProtoRule.style:type_name -> ProtoRuleStyle
	31,  // 419: ProtoRule.mode:type_name -> ProtoRuleMode
	132, // 420: ProtoRule.boundaries:type_name -> ProtoRuleBoundaries
	41,  // 421: ProtoRuleBoundaries.start:type_name -> ProtoMeasure
	41,  // 422: ProtoRuleBoundaries.end:type_name -> ProtoMeasure
	48,  // 423: ProtoColorDef.color:type_name -> ProtoColor
	70,  // 424: ProtoLayout.parent:type_name -> ProtoDocumentElement
	70,  // 425: ProtoAdvancedIllustrationArea._children:type_name -> ProtoDocumentElement
	70,  // 426: ProtoAdvancedIllustrationArea.parent:type_name -> ProtoDocumentElement
	41,  // 427: ProtoAdvancedIllustrationArea.width:type_name -> ProtoMeasure
	41,  // 428: ProtoAdvancedIllustrationArea.height:type_name -> ProtoMeasure
	41,  // 429: ProtoAdvancedIllustrationArea.x:type_name -> ProtoMeasure
	41,  // 430: ProtoAdvancedIllustrationArea.y:type_name -> ProtoMeasure
	3,   // 431: ProtoAdvancedIllustrationArea.textFlow:type_name -> ProtoAdvancedIllustrationAreaTextFlowType
	70,  // 432: ProtoAdjustHorizontally._children:type_name -> ProtoDocumentElement
	70,  // 433: ProtoAdjustHorizontally.parent:type_name -> ProtoDocumentElement
	41,  // 434: ProtoAdjustHorizontally.minFontSize:type_name -> ProtoMeasure
	41,  // 435: ProtoAdjustHorizontally.maxFontSize:type_name -> ProtoMeasure
	70,  // 436: ProtoDoctypeScript.parent:type_name -> ProtoDocumentElement
	32,  // 437: ProtoDoctypeScript.outputMode:type_name -> ProtoDoctypeOutputMode
	70,  // 438: ProtoDmScript.parent:type_name -> ProtoDocumentElement
	70,  // 439: ProtoDynamicTemplate.parent:type_name -> ProtoDocumentElement
	70,  // 440: ProtoSelection._children:type_name -> ProtoDocumentElement
	70,  // 441: ProtoSelection.parent:type_name -> ProtoDocumentElement
	70,  // 442: ProtoSelectionEntry._children:type_name -> ProtoDocumentElement
	70,  // 443: ProtoSelectionEntry.parent:type_name -> ProtoDocumentElement
	70,  // 444: ProtoCondition._children:type_name -> ProtoDocumentElement
	70,  // 445: ProtoCondition.parent:type_name -> ProtoDocumentElement
	70,  // 446: ProtoPageCondition._children:type_name -> ProtoDocumentElement
	70,  // 447: ProtoPageCondition.parent:type_name -> ProtoDocumentElement
	70,  // 448: ProtoLocale._children:type_name -> ProtoDocumentElement
	70,  // 449: ProtoLocale.parent:type_name -> ProtoDocumentElement
	70,  // 450: ProtoTag.parent:type_name -> ProtoDocumentElement
	70,  // 451: ProtoParagraphSetDefault.parent:type_name -> ProtoDocumentElement
	69,  // 452: ProtoBaseTextInputField.base:type_name -> ProtoBaseInputField
	42,  // 453: ProtoBaseTextInputField.pdf_size:type_name -> ProtoBoxedMeasure
	42,  // 454: ProtoBaseTextInputField.pdfInputHeight:type_name -> ProtoBoxedMeasure
	70,  // 455: ProtoInputFieldText.parent:type_name -> ProtoDocumentElement
	147, // 456: ProtoInputFieldText.base:type_name -> ProtoBaseTextInputField
	70,  // 457: ProtoInputFieldDate.parent:type_name -> ProtoDocumentElement
	147, // 458: ProtoInputFieldDate.base:type_name -> ProtoBaseTextInputField
	70,  // 459: ProtoInputFieldCheckbox.parent:type_name -> ProtoDocumentElement
	69,  // 460: ProtoInputFieldCheckbox.base:type_name -> ProtoBaseInputField
	70,  // 461: ProtoInputFieldLabel.parent:type_name -> ProtoDocumentElement
	147, // 462: ProtoInputFieldLabel.base:type_name -> ProtoBaseTextInputField
	70,  // 463: ProtoInputFieldDropdown.parent:type_name -> ProtoDocumentElement
	147, // 464: ProtoInputFieldDropdown.base:type_name -> ProtoBaseTextInputField
	68,  // 465: ProtoInputFieldDropdown.options:type_name -> ProtoOption
	48,  // 466: ProtoColorChoice.color:type_name -> ProtoColor
	70,  // 467: ProtoSetColor.parent:type_name -> ProtoDocumentElement
	153, // 468: ProtoSetColor.color:type_name -> ProtoColorChoice
	70,  // 469: ProtoUnsetColor.parent:type_name -> ProtoDocumentElement
	153, // 470: ProtoUnsetColor.color:type_name -> ProtoColorChoice
	70,  // 471: ProtoColoredArea.parent:type_name -> ProtoDocumentElement
	70,  // 472: ProtoColoredArea._children:type_name -> ProtoDocumentElement
	153, // 473: ProtoColoredArea.color:type_name -> ProtoColorChoice
	70,  // 474: ProtoChapter._children:type_name -> ProtoDocumentElement
	70,  // 475: ProtoChapter.parent:type_name -> ProtoDocumentElement
	70,  // 476: ProtoTableOfContents._children:type_name -> ProtoDocumentElement
	70,  // 477: ProtoTableOfContents.parent:type_name -> ProtoDocumentElement
	70,  // 478: ProtoSectionReference.parent:type_name -> ProtoDocumentElement
	70,  // 479: ProtoChapterLink._children:type_name -> ProtoDocumentElement
	161, // 480: searchable:extendee -> google.protobuf.FieldOptions
	161, // 481: weight:extendee -> google.protobuf.FieldOptions
	161, // 482: field_group:extendee -> google.protobuf.FieldOptions
	161, // 483: identity:extendee -> google.protobuf.FieldOptions
	484, // [484:484] is the sub-list for method output_type
	484, // [484:484] is the sub-list for method input_type
	484, // [484:484] is the sub-list for extension type_name
	480, // [480:484] is the sub-list for extension extendee
...
func file_build_docframe_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		ExtensionInfos:    file_build_docframe_proto_extTypes,
	}.Build()
