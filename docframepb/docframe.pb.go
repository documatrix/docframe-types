...
type ProtoNewPage struct {
	...
	ComChannelUUIDs []string               `protobuf:"bytes,5,rep,name=comChannelUUIDs,proto3" json:"comChannelUUIDs,omitempty"`
	TrayUUID        string                 `protobuf:"bytes,6,opt,name=trayUUID,proto3" json:"trayUUID,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *ProtoNewPage) GetTrayUUID() string {
	if x != nil {
		return x.TrayUUID
	}
	return ""
...
const file_build_docframe_proto_rawDesc = "" +
	...
	"\x0fcomChannelUUIDs\x18\x03 \x03(\tR\x0fcomChannelUUIDs\"\xff\x01\n" +
	...
	"\x0fcomChannelUUIDs\x18\x05 \x03(\tR\x0fcomChannelUUIDs\x12\x1a\n" +
	"\btrayUUID\x18\x06 \x01(\tR\btrayUUID\"\x85\x02\n" +
