...
const file_build_docframe_proto_rawDesc = "" +
	...
	"\x04uuid\x18\x03 \x01(\tR\x04uuid\x12(\n" +
	"\x0fcomChannelUUIDs\x18\x04 \x03(\tR\x0fcomChannelUUIDs\x12$\n" +
	"\x04mode\x18\x05 \x01(\x0e2\x10.ProtoFooterModeR\x04mode\"\xcc\x16\n" +
	"\x04Node\x12!\n" +
	...
	"\tcondition\x18G \x01(\v2\x0f.ProtoConditionH\x00R\tconditionB\b\n" +
	"\x06object\"\x9b\b\n" +
	"\n" +
	"ProtoImage\x12-\n" +
	...
	"\x13FOOTER_MODE_REPLACE\x10\x03*\xb3\x0f\n" +
	"\bNodeType\x12,\n" +
	...
	"\x1aDOCUMENT_ELEMENT_CONDITION\x10M*\xa3\x01\n" +
...
var file_build_docframe_proto_msgTypes = make([]protoimpl.MessageInfo, 106)
...
var file_build_docframe_proto_depIdxs = []int32{
	...
	64,  // 268: ProtoImage.parent:type_name -> ProtoDocumentElement
	30,  // 269: ProtoImage.scale:type_name -> ProtoBoxedDouble
	30,  // 270: ProtoImage.columnScale:type_name -> ProtoBoxedDouble
	38,  // 271: ProtoImage.width:type_name -> ProtoBoxedMeasure
	38,  // 272: ProtoImage.height:type_name -> ProtoBoxedMeasure
	38,  // 273: ProtoImage.x:type_name -> ProtoBoxedMeasure
	38,  // 274: ProtoImage.y:type_name -> ProtoBoxedMeasure
	29,  // 275: ProtoImage.positionAbsolute:type_name -> ProtoBoxedBool
	63,  // 276: ProtoImage.flipSettings:type_name -> ProtoFlipSettings
	62,  // 277: ProtoImage.cropSettings:type_name -> ProtoCropSettings
	41,  // 278: ProtoImage.aia:type_name -> ProtoAdvancedIllustrationAreaImageSettings
	10,  // 279: ProtoImage.referencePoint:type_name -> ProtoImageReferencePoint
	22,  // 280: ProtoImage.imageContentType:type_name -> ProtoImageContentType
	20,  // 281: ProtoImage.scaleType:type_name -> ProtoImageScaleType
	21,  // 282: ProtoImage.UAMode:type_name -> ProtoImageUAMode
	64,  // 283: ProtoDirectory._children:type_name -> ProtoDocumentElement
	64,  // 284: ProtoDirectory.parent:type_name -> ProtoDocumentElement
	11,  // 285: ProtoDirectory.semanticType:type_name -> ProtoSemanticType
	64,  // 286: ProtoTextBrick._children:type_name -> ProtoDocumentElement
	64,  // 287: ProtoTextBrick.parent:type_name -> ProtoDocumentElement
	64,  // 288: ProtoVariable.parent:type_name -> ProtoDocumentElement
	23,  // 289: ProtoVariable.specialType:type_name -> ProtoVariableSpecialType
	64,  // 290: ProtoFormatted.parent:type_name -> ProtoDocumentElement
	57,  // 291: ProtoCDef.columSettings:type_name -> ProtoColumnSettings
	29,  // 292: ProtoCDef.applyToHeaderFooter:type_name -> ProtoBoxedBool
	29,  // 293: ProtoCDef.applyImmediate:type_name -> ProtoBoxedBool
	38,  // 294: ProtoPDef.pageWidth:type_name -> ProtoBoxedMeasure
	38,  // 295: ProtoPDef.pageDepth:type_name -> ProtoBoxedMeasure
	38,  // 296: ProtoPtConfig.height:type_name -> ProtoBoxedMeasure
	38,  // 297: ProtoPtConfig.lineFeed:type_name -> ProtoBoxedMeasure
	38,  // 298: ProtoPtConfig.characterWidth:type_name -> ProtoBoxedMeasure
	38,  // 299: ProtoPtConfig.spaceWidth:type_name -> ProtoBoxedMeasure
	9,   // 300: ProtoUlConfig.mode:type_name -> ProtoUnderlineMode
	24,  // 301: ProtoNewPage.pageMode:type_name -> ProtoPageMode
	25,  // 302: ProtoNewPage.pageOrientation:type_name -> ProtoPageOrientation
	64,  // 303: ProtoIndentation._children:type_name -> ProtoDocumentElement
	64,  // 304: ProtoIndentation.parent:type_name -> ProtoDocumentElement
	38,  // 305: ProtoIndentation.left:type_name -> ProtoBoxedMeasure
	38,  // 306: ProtoIndentation.right:type_name -> ProtoBoxedMeasure
	64,  // 307: ProtoCarryOver._children:type_name -> ProtoDocumentElement
	64,  // 308: ProtoCarryOver.parent:type_name -> ProtoDocumentElement
	64,  // 309: ProtoLoopEntry._children:type_name -> ProtoDocumentElement
	64,  // 310: ProtoLoopEntry.parent:type_name -> ProtoDocumentElement
	64,  // 311: ProtoLoop._children:type_name -> ProtoDocumentElement
	64,  // 312: ProtoLoop.parent:type_name -> ProtoDocumentElement
	64,  // 313: ProtoSubTotal._children:type_name -> ProtoDocumentElement
	64,  // 314: ProtoSubTotal.parent:type_name -> ProtoDocumentElement
	26,  // 315: ProtoSubTotal.position:type_name -> ProtoSubTotalPosition
	37,  // 316: ProtoSubTotal.height:type_name -> ProtoMeasure
	64,  // 317: ProtoWsArea._children:type_name -> ProtoDocumentElement
	64,  // 318: ProtoWsArea.parent:type_name -> ProtoDocumentElement
	37,  // 319: ProtoRule.xOffset:type_name -> ProtoMeasure
	37,  // 320: ProtoRule.yOffset:type_name -> ProtoMeasure
	37,  // 321: ProtoRule.width:type_name -> ProtoMeasure
	37,  // 322: ProtoRule.thickness:type_name -> ProtoMeasure
	44,  // 323: ProtoRule.color:type_name -> ProtoColor
	1,   // 324: ProtoRule.style:type_name -> ProtoRuleStyle
	27,  // 325: ProtoRule.mode:type_name -> ProtoRuleMode
	124, // 326: ProtoRule.boundaries:type_name -> ProtoRuleBoundaries
	37,  // 327: ProtoRuleBoundaries.start:type_name -> ProtoMeasure
	37,  // 328: ProtoRuleBoundaries.end:type_name -> ProtoMeasure
	44,  // 329: ProtoColorDef.color:type_name -> ProtoColor
	64,  // 330: ProtoLayout.parent:type_name -> ProtoDocumentElement
	64,  // 331: ProtoAdvancedIllustrationArea._children:type_name -> ProtoDocumentElement
	64,  // 332: ProtoAdvancedIllustrationArea.parent:type_name -> ProtoDocumentElement
	37,  // 333: ProtoAdvancedIllustrationArea.width:type_name -> ProtoMeasure
	37,  // 334: ProtoAdvancedIllustrationArea.height:type_name -> ProtoMeasure
	37,  // 335: ProtoAdvancedIllustrationArea.x:type_name -> ProtoMeasure
	37,  // 336: ProtoAdvancedIllustrationArea.y:type_name -> ProtoMeasure
	3,   // 337: ProtoAdvancedIllustrationArea.textFlow:type_name -> ProtoAdvancedIllustrationAreaTextFlowType
	64,  // 338: ProtoAdjustHorizontally._children:type_name -> ProtoDocumentElement
	64,  // 339: ProtoAdjustHorizontally.parent:type_name -> ProtoDocumentElement
	37,  // 340: ProtoAdjustHorizontally.minFontSize:type_name -> ProtoMeasure
	37,  // 341: ProtoAdjustHorizontally.maxFontSize:type_name -> ProtoMeasure
	64,  // 342: ProtoDoctypeScript.parent:type_name -> ProtoDocumentElement
	28,  // 343: ProtoDoctypeScript.outputMode:type_name -> ProtoDoctypeOutputMode
	64,  // 344: ProtoDmScript.parent:type_name -> ProtoDocumentElement
	64,  // 345: ProtoDynamicTemplate.parent:type_name -> ProtoDocumentElement
	64,  // 346: ProtoSelection._children:type_name -> ProtoDocumentElement
	64,  // 347: ProtoSelection.parent:type_name -> ProtoDocumentElement
	64,  // 348: ProtoSelectionEntry._children:type_name -> ProtoDocumentElement
	64,  // 349: ProtoSelectionEntry.parent:type_name -> ProtoDocumentElement
	64,  // 350: ProtoCondition._children:type_name -> ProtoDocumentElement
	64,  // 351: ProtoCondition.parent:type_name -> ProtoDocumentElement
