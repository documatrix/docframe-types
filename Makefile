...
build/docframe.proto: $(PROTO_FILES)
	mkdir -p build
...
build/Docframe.js: build/docframe.proto
...
build/Docframe.d.ts: build/Docframe.js
	./node_modules/.bin/pbts -o ./build/Docframe.d.ts ./build/Docframe.js

build/Docframe.cs: build/docframe.proto
	buf generate --template buf.gen.yaml --path build/docframe.proto

docframepb/docframe.pb.go: build/docframe.proto
	buf generate --template buf.gen.yaml --path build/docframe.proto

gen/document_elements/v1/message_generated.go: build/Docframe.js build/Docframe.d.ts build/Docframe.cs docframepb/docframe.pb.go
	cd docframepb && go generate .
