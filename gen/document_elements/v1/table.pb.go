...
const file_document_elements_v1_table_proto_rawDesc = "" +
	"\n" +
	" document_elements/v1/table.proto\x12\x14document_elements.v1\x1a\x11box/v1/bool.proto\x1a\x13box/v1/double.proto\x1a\x13box/v1/string.proto\x1a\x13box/v1/uint32.proto\x1a\x14utils/v1/align.proto\x1a\x15utils/v1/border.proto\x1a\x14utils/v1/color.proto\x1a\x16utils/v1/measure.proto\"y\n" +
	"\x10ProtoTableConfig\x12D\n" +
	"\bsettings\x18\x01 \x01(\v2(.document_elements.v1.ProtoTableSettingsR\bsettings\x12\x1f\n" +
	"\vconfig_name\x18\x02 \x01(\tR\n" +
	"configName\"\xa3\x02\n" +
	"\x12ProtoTableSettings\x121\n" +
	"\bx_offset\x18\x01 \x01(\v2\x16.utils.v1.ProtoMeasureR\axOffset\x129\n" +
	"\fleft_measure\x18\x02 \x01(\v2\x16.box.v1.ProtoBoxedBoolR\vleftMeasure\x12,\n" +
	"\x05width\x18\x03 \x01(\v2\x16.utils.v1.ProtoMeasureR\x05width\x12=\n" +
	"\rrepeat_header\x18\x04 \x01(\v2\x18.box.v1.ProtoBoxedUint32R\frepeatHeader\x122\n" +
	"\x02ws\x18\x05 \x01(\v2\".document_elements.v1.ProtoTableWSR\x02ws\"\x82\x01\n" +
	"\x1fProtoBoxedTableContentGroupType\x12F\n" +
	"\x05value\x18\x01 \x01(\x0e20.document_elements.v1.ProtoTableContentGroupTypeR\x05value\x12\x17\n" +
	"\ais_null\x18\x02 \x01(\bR\x06isNull\"\x96\x01\n" +
	"\x16ProtoTableContentGroup\x12P\n" +
	"\bsettings\x18\x01 \x01(\v24.document_elements.v1.ProtoTableContentGroupSettingsR\bsettings\x12*\n" +
	"\x11com_channel_uuids\x18\x02 \x03(\tR\x0fcomChannelUuids\"\xbd\x01\n" +
	"\x1cProtoTableContentGroupConfig\x12P\n" +
	"\bsettings\x18\x01 \x01(\v24.document_elements.v1.ProtoTableContentGroupSettingsR\bsettings\x12\x1f\n" +
	"\vconfig_name\x18\x02 \x01(\tR\n" +
	"configName\x12*\n" +
	"\x11com_channel_uuids\x18\x03 \x03(\tR\x0fcomChannelUuids\"\xfc\x01\n" +
	"\x1eProtoTableContentGroupSettings\x12c\n" +
	"\x12content_group_type\x18\x01 \x01(\v25.document_elements.v1.ProtoBoxedTableContentGroupTypeR\x10contentGroupType\x12A\n" +
	"\x11background_colors\x18\x02 \x03(\v2\x14.utils.v1.ProtoColorR\x10backgroundColors\x122\n" +
	"\x02ws\x18\x03 \x01(\v2\".document_elements.v1.ProtoTableWSR\x02ws\"\xca\x01\n" +
	"\rProtoTableRow\x12G\n" +
	"\bsettings\x18\x01 \x01(\v2+.document_elements.v1.ProtoTableRowSettingsR\bsettings\x12D\n" +
	"\x11row_config_number\x18\x02 \x01(\v2\x18.box.v1.ProtoBoxedUint32R\x0frowConfigNumber\x12*\n" +
	"\x11com_channel_uuids\x18\x03 \x03(\tR\x0fcomChannelUuids\"\xe9\x01\n" +
	"\x13ProtoTableRowConfig\x12G\n" +
	"\bsettings\x18\x01 \x01(\v2+.document_elements.v1.ProtoTableRowSettingsR\bsettings\x12\x1f\n" +
	"\vconfig_name\x18\x02 \x01(\tR\n" +
	"configName\x12\x1d\n" +
	"\n" +
	"row_header\x18\x03 \x01(\tR\trowHeader\x12\x1d\n" +
	"\n" +
	"row_footer\x18\x04 \x01(\tR\trowFooter\x12*\n" +
	"\x11com_channel_uuids\x18\x05 \x03(\tR\x0fcomChannelUuids\"\x82\x01\n" +
	"\x15ProtoTableRowSettings\x125\n" +
	"\n" +
	"min_height\x18\x01 \x01(\v2\x16.utils.v1.ProtoMeasureR\tminHeight\x122\n" +
	"\x02ws\x18\x02 \x01(\v2\".document_elements.v1.ProtoTableWSR\x02ws\"r\n" +
	"\x17ProtoBoxedTableCellType\x12>\n" +
	"\x05value\x18\x01 \x01(\x0e2(.document_elements.v1.ProtoTableCellTypeR\x05value\x12\x17\n" +
	"\ais_null\x18\x02 \x01(\bR\x06isNull\"\xbc\x02\n" +
	"\x0eProtoTableCell\x12H\n" +
	"\bsettings\x18\x01 \x01(\v2,.document_elements.v1.ProtoTableCellSettingsR\bsettings\x12F\n" +
	"\x12cell_config_number\x18\x02 \x01(\v2\x18.box.v1.ProtoBoxedUint32R\x10cellConfigNumber\x12.\n" +
	"\x05index\x18\x03 \x01(\v2\x18.box.v1.ProtoBoxedUint32R\x05index\x12\x1f\n" +
	"\vmerged_left\x18\x04 \x01(\bR\n" +
	"mergedLeft\x12\x1b\n" +
	"\tmerged_up\x18\x05 \x01(\bR\bmergedUp\x12*\n" +
	"\x11com_channel_uuids\x18\x06 \x03(\tR\x0fcomChannelUuids\"\xf9\x01\n" +
	"\x14ProtoTableCellConfig\x12H\n" +
	"\bsettings\x18\x01 \x01(\v2,.document_elements.v1.ProtoTableCellSettingsR\bsettings\x12\x1f\n" +
	"\vconfig_name\x18\x02 \x01(\tR\n" +
	"configName\x12J\n" +
	"\tcell_type\x18\x03 \x01(\v2-.document_elements.v1.ProtoBoxedTableCellTypeR\bcellType\x12*\n" +
	"\x11com_channel_uuids\x18\x04 \x03(\tR\x0fcomChannelUuids\"\xaf\x04\n" +
	"\x16ProtoTableCellSettings\x12,\n" +
	"\x05width\x18\x01 \x01(\v2\x16.utils.v1.ProtoMeasureR\x05width\x12=\n" +
	"\x05align\x18\x02 \x01(\v2'.utils.v1.ProtoBoxedHorizontalAlignmentR\x05align\x12=\n" +
	"\x06valign\x18\x03 \x01(\v2%.utils.v1.ProtoBoxedVerticalAlignmentR\x06valign\x12?\n" +
	"\x10background_color\x18\x04 \x01(\v2\x14.utils.v1.ProtoColorR\x0fbackgroundColor\x125\n" +
	"\apadding\x18\x05 \x01(\v2\x1b.utils.v1.ProtoSideMeasuresR\apadding\x122\n" +
	"\x06border\x18\x06 \x01(\v2\x1a.utils.v1.ProtoSideBordersR\x06border\x123\n" +
	"\x06margin\x18\a \x01(\v2\x1b.utils.v1.ProtoSideMeasuresR\x06margin\x124\n" +
	"\brotation\x18\b \x01(\v2\x18.box.v1.ProtoBoxedDoubleR\brotation\x12R\n" +
	"\x18default_paragraph_format\x18\t \x01(\v2\x18.box.v1.ProtoBoxedStringR\x16defaultParagraphFormat\"|\n" +
	"\fProtoTableWS\x12(\n" +
	"\x10min_lines_before\x18\x01 \x01(\rR\x0eminLinesBefore\x12&\n" +
	"\x0fmin_lines_after\x18\x02 \x01(\rR\rminLinesAfter\x12\x1a\n" +
	"\bpriority\x18\x03 \x01(\rR\bpriority*\xca\x01\n" +
	"\x1aProtoTableContentGroupType\x12'\n" +
	"#PROTO_TABLE_CONTENT_GROUP_TYPE_BODY\x10\x00\x12)\n" +
	"%PROTO_TABLE_CONTENT_GROUP_TYPE_HEADER\x10\x01\x12)\n" +
	"%PROTO_TABLE_CONTENT_GROUP_TYPE_FOOTER\x10\x02\x12-\n" +
	")PROTO_TABLE_CONTENT_GROUP_TYPE_SUB_HEADER\x10\x03*\x80\x01\n" +
	"\x12ProtoTableCellType\x12\x1e\n" +
	"\x1aPROTO_TABLE_CELL_TYPE_BODY\x10\x00\x12$\n" +
	" PROTO_TABLE_CELL_TYPE_ROW_HEADER\x10\x01\x12$\n" +
	" PROTO_TABLE_CELL_TYPE_ROW_FOOTER\x10\x02B\xe6\x01\n" +
	"\x18com.document_elements.v1B\n" +
	"TableProtoP\x01ZQgithub.com/documatrix/docframe-types/gen/document_elements/v1;document_elementsv1\xa2\x02\x03DXX\xaa\x02\x13DocumentElements.V1\xca\x02\x13DocumentElements\\V1\xe2\x02\x1fDocumentElements\\V1\\GPBMetadata\xea\x02\x14DocumentElements::V1b\x06proto3"

var (
	file_document_elements_v1_table_proto_rawDescOnce sync.Once
	file_document_elements_v1_table_proto_rawDescData []byte
)

func file_document_elements_v1_table_proto_rawDescGZIP() []byte {
	file_document_elements_v1_table_proto_rawDescOnce.Do(func() {
		file_document_elements_v1_table_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_document_elements_v1_table_proto_rawDesc), len(file_document_elements_v1_table_proto_rawDesc)))
	})
...
var file_document_elements_v1_table_proto_goTypes = []any{
...
func file_document_elements_v1_table_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_document_elements_v1_table_proto_rawDesc), len(file_document_elements_v1_table_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   14,
			NumExtensions: 0,
			NumServices:   0,
